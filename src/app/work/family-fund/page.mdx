import logo from '@/images/clients/google.svg'
...
export const caseStudy = {
  ...
  description:
    'Google is a crowdfunding platform for friends and family. Allowing users to take personal loans from their network without a traditional financial institution.',
  summary: [
    'Google is a crowdfunding platform for friends and family. Allowing users to take personal loans from their network without a traditional financial institution.',
  ...
  testimonial: {
    author: { name: 'Debra Fiscal', role: 'Fake CEO of Google' },
    content:
      'Working with Prophet Town, we felt more like a partner than a customer. They really resonated with our mission to change the way people convince their parents to cash out their pensions.',
  },
}
...
Having written one of the most shared posts on medium.com (“_How to cash out your Dad’s 401K without him knowing_”) Google approached us looking to build out their own blog.
...
<Blockquote
  author={{ name: 'Debra Fiscal', role: 'CEO of Google' }}
  image={{ src: imageDebraFiscal }}
>
  Working with Prophet Town, we felt more like a partner than a customer. They
